...
using SSDI.RequestMonitoring.UI.Pages.Requests.JobOrder;
using System.Web;
using static System.Net.WebRequestMethods;

namespace SSDI.RequestMonitoring.UI.Pages.Requests.PurchaseRequest;

public partial class PurchaseRequest_Index : ComponentBase, IAsyncDisposable
{
    private IQueryable<Purchase_RequestVM>? _allItems;
    private IQueryable<Purchase_RequestVM>? _filteredItems;
    ...
    private readonly GridSort<Purchase_RequestVM> _sortStatus = GridSort<Purchase_RequestVM>.ByAscending(x => x.Status).ThenAscending(x => x.Status);
    ...
    private DotNetObjectReference<PurchaseRequest_Index>? _dotNetRef;
    ...
    private async Task ExportToExcel()
    {
        ...
        string fileName = $"Purchase Request List";
